 ...
 * application.
 */
public class FinalSoldier extends JPanel {
    ...
    public static void main(String[] args) {
        ...
        FinalSoldier content = new FinalSoldier();
    ...
    public FinalSoldier() {
        ...
        board.setBounds(0, 0, 664, 664); // Note: size MUST be 164-by-164 !
       // newGameButton.setBounds(410, 60, 120, 30);
       // resignButton.setBounds(410, 120, 120, 30);
       // message.setBounds(410, 200, 350, 30);
    ...
    private class Board extends JPanel implements ActionListener, MouseListener {
        ...
        public void paintComponent(Graphics g) {
            ...
            g.drawLine(10,160,10, 453);
            g.drawLine(0,460,300, 460); 
            g.drawLine(310,160,310, 453);
            
            g.drawLine(10,460,310, 160);
            g.drawLine(10,160,310, 460);

            g.drawLine(160,0,160, 610);
            g.drawLine(10,310,310, 310);
            g.drawLine(10,235,310, 235);
            g.drawLine(10,385,310, 385);

            g.drawLine(10,310,155, 160);
            g.drawLine(160,155,310, 310);
            g.drawLine(310,460,155, 460);

            g.drawLine(10,310,155, 450);
            g.drawLine(155,450,310, 310);

            g.drawLine(85,160,85, 460);
            g.drawLine(235,160,235, 460);

            g.drawLine(0,10,300, 10);
            g.drawLine(95,85,250, 85);
            g.drawLine(10,10,155, 160);
            g.drawLine(310,10,155, 160);

            g.drawLine(0,610,300, 610);
            g.drawLine(95,535,250, 535);
            g.drawLine(10,610,155, 460);
            g.drawLine(310,610,155, 460);
            ...
            for (int row = 0; row < 9; row++) {
                for (int col = 0; col < 5; col++) {
                    ...
                    g.fillRect(2 + col * 75, 2 + row * 75, 20, 20);

                    switch (board.pieceAt(row, col)) {
                        case CheckersData.RED:
                            g.setColor(Color.RED);
                            g.fillOval(4 + col * 75, 4 + row * 75, 15, 15);
                            break;
            ...
            if (gameInProgress) {
                ...
                for (int i = 0; i < legalMoves.length; i++) {
                    g.drawRect(2 + legalMoves[i].fromCol * 75, 2 + legalMoves[i].fromRow * 75, 19, 19);
                    g.drawRect(3 + legalMoves[i].fromCol * 75, 3 + legalMoves[i].fromRow * 75, 17, 17);
                }
                /*
                ...
                if (selectedRow >= 0) {
                    ...
                    g.drawRect(2 + selectedCol * 75, 2 + selectedRow * 75, 19, 19);
                    g.drawRect(3 + selectedCol * 75, 3 + selectedRow * 75, 17, 17);
                    g.setColor(Color.green);
                    for (int i = 0; i < legalMoves.length; i++) {
                        if (legalMoves[i].fromCol == selectedCol && legalMoves[i].fromRow == selectedRow) {
                            g.drawRect(2 + legalMoves[i].toCol * 75, 2 + legalMoves[i].toRow * 75, 19, 19);
                            g.drawRect(3 + legalMoves[i].toCol * 75, 3 + legalMoves[i].toRow * 75, 17, 17);
                        }
                    }
                }
            }
        ...
        public void mousePressed(MouseEvent evt) {
            if (gameInProgress == false)
                ...
                int col = (evt.getX() - 2) / 75;
                int row = (evt.getY() - 2) / 75;
                if (col >= 0 && col < 5 && row >= 0 && row < 9)
    ...
    private static class CheckersData {
        ...
        void setUpGame() {
            for (int row = 0; row < 9; row++) {
                for (int col = 0; col < 5; col++) {
                    ...
                    if((row==0&&col==1)||(row==0&&col==3)||(row==1&&col==0)||(row==1&&col==4))
                        board[row][col] =-1;
                    if((row==7&&col==0)||(row==7&&col==4)||(row==8&&col==1)||(row==8&&col==3))
                        board[row][col] =-1;
                }
            }
        } // end setUpGame()
        ...
        void makeMove(int fromRow, int fromCol, int toRow, int toCol) {
            ...
            if (fromCol - toCol == 4 || fromCol - toCol == -4) {
                // The move is a jump. Remove the jumped piece from the board.
                int jumpRow = (fromRow + toRow) / 2; // Row of the jumped piece.
                int jumpCol = (fromCol + toCol) / 2; // Column of the jumped piece.
                board[jumpRow][jumpCol] = EMPTY;
                        ...
                        if (board[row][col] == player) {
                            ...
                            if(row>=0&&row<2)
                            {
                                ...
                                if((row==0&&col==0))
                                {
                                    ...
                                    //right
                                    if(canMove(player, row, col, row , col+2))
            ...
            for (int row = 0; row < 9; row++) {
                for (int col = 0; col < 5; col++) {
                    if (board[row][col] == player) {
                        ...
                        if(row==0&&col==4)
                        {
                            if(canJump(player,row,col,row,col-2,row, col-4))
                                moves.add(new CheckersMove(row, col, row , col-4 ));
        ...
        private boolean canJump(int player, int r1, int c1, int r2, int c2, int r3, int c3) {
         ...
         /*   //upper triangle row 1st
            if((r1==0&&c1==4))
            {
                if(player==BLACK)
                {
                    if(board[r2][c2]==RED&&board[r3][c3]==EMPTY)
                        return true;
                ...
                {
                    if(board[r2][c2]==BLACK&&board[r3][c3]==EMPTY)
                        return true;
            ...
            if (player == RED) 
            {
                ...
                //    return true; // Regular red piece can only move up.
               ...
               // if (board[r1][c1] == BLACK && r3 < r1)
               //     return true; // Regular black piece can only move downn.
                if (board[r2][c2] != RED )
        ...
        private boolean canMove(int player, int r1, int c1, int r2, int c2) {
            ...
            if (player == RED) {
                if (board[r1][c1] == RED && r2 > r1)
                    return true; // Regular red piece can only move down.
                ...
                if (board[r1][c1] == BLACK && r2 < r1)
                    return true; // Regular black piece can only move up.
                return true; // The move is legal.
            }
